...
import com.example.cook.global.oauth2.userinfo.GoogleOAuth2UserInfo;
import com.example.cook.global.oauth2.userinfo.KakaoOAuth2UserInfo;
import com.example.cook.global.oauth2.userinfo.NaverOAuth2UserInfo;
import com.example.cook.global.oauth2.userinfo.OAuth2UserInfo;
...
public class OAuthAttributes {
   ...
   * 소셜별 of 메소드(ofGoogle, ofKaKao, ofNaver)들은 각각 소셜 로그인 API에서 제공하는 회원의 식별값(id), attributes, nameAttributeKey를 저장 후 build
   */
  ...
  /**
   * 이후에 CustomOAuth2UserService에서 DB에 저장할 내 서비스 User를 OAuth2UserInfo의 정보를 사용하여 빌더로 빌드 후 반환합니다.
