package com.example.cook.global.oauth2.service;

import com.example.cook.global.oauth2.CustomOAuth2User;
import com.example.cook.global.oauth2.OAuthAttributes;
...
/**
 * OAuth 2.0 로그인 프로세스를 처리하고, 사용자 정보를 가져와서 애플리케이션에 통합
 *
